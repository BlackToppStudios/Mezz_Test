...
*/
#ifndef Mezz_Test_OutputBufferGuardTests_h
...
class OutputBufferGuardTests : public Mezzanine::Testing::UnitTestGroup
{
    public:
        /// @brief Default Constructor
        OutputBufferGuardTests() = default;

        /// @brief Default Deconstructor
        virtual ~OutputBufferGuardTests() = default;

        // This is used as the name of the test on the command prompt
        virtual Mezzanine::String Name() override
            { return "outputbufferguard"; }
