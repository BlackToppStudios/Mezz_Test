...
// Test Macros.
        ...
        /// @brief Defines a test group that uses policy settings in the class Mezzanine::Testing::AutomaticTestGroup.
        ...
        /// @brief Defines a test group that uses policy settings in the class Mezzanine::Testing::BenchmarkTestGroup
        ...
        /// Mezzanine::Testing::BenchmarkThreadTestGroup so it will not run parallel to any other tests and will get
        /// its own process.
...
// Tests to use in UnitTestGroup.
            ...
            /// equality tests.
            /// This uses the types == operator and if unequal uses the types << operator(ostream&) to emit an error
            /// message displaying the expected results and the actual results.
            /// @note This calls a member function on the UnitTestGroup class, so it can only be used in UnitTestGroup
            /// functions or in functions on classes inherited from UnitTestGroup, like BenchmarkTestGroup or
            /// AutomaticTestGroup.
            /// @param Name The name of the current test.
            ...
            /// @brief Compares types that might fluctuate because of the imprecision of floating point values.
            ...
            /// std::numeric_limits<ExpectedResultsType>::epsilon() to determine how big the error should be. This
            /// multiplies the epsilon by the passed EpsilonFactor to determine the size of the error. This should be
            /// no more than the maximum amount of floating point operations performed, and in practice rarely needs to
            /// be more than 5.
            /// @note This calls a member function on the UnitTestGroup class, so it can only be used in UnitTestGroup
            /// functions or in functions on classes inherited from UnitTestGroup, like BenchmarkTestGroup or
            /// AutomaticTestGroup.
            ...
            /// @param ExpectedResults The amount expected, plus or minus the std::numerics_limits epsilon of the type.
            /// @param ActualResults The tested amount that the test process actually produced.
            /// @param EpsilonFactor How many times operations could occur that could cause rounding presuming the
            /// number is near zero, use judgement.
            #ifdef __FUNCTION__
            ...
            /// @todo Check the above line's documentation.
            /// @details This captures test location meta data and should be considered the default way to record tests
        ...
        #ifndef TEST_THROW
            /// @def TEST_THROW
            /// @brief An easy way to test whether a function/code snippet throws exceptions (or whatever) as expected.
            ...
            /// @def TEST_NO_THROW
            /// @brief An easy way to test whether a function/code snippet does not throw exceptions (or whatever) as
            /// expected.
            /// @details This captures test location meta data and should be considered the default way to capture
            /// exception tests.
            /// @note This calls a member function on the UnitTestGroup class, so it can only be used in UnitTestGroup
        ...
        #ifndef TEST_TIMED
            /// @def TEST_TIMED
            /// @brief An easy way to test whether a function/code snippet takes approximately the expected amount of
            /// time to run.
            ...
            /// @param ExpectedTime The expected amount of time in microseconds.
            /// @param Variance The amount of microseconds this is allowed to be off in either direction.
            /// @param Name The name of the current test.
            #ifdef __FUNCTION__
            ...
            /// @brief Used to check the upper amount of time the code should take to execute.
            /// @details This starts a timer just before the CodeToTime is executed and stops that time right after it
            /// finishes.
            /// @note This calls a member function on the UnitTestGroup class, so it can only be used in UnitTestGroup
            /// functions or in functions on classes inherited from UnitTestGroup, like BenchmarkTestGroup or
